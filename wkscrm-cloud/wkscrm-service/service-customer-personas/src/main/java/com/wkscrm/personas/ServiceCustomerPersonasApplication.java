...
public class ServiceCustomerPersonasApplication {
    public static void main(String[] args) {
        SpringApplication.run(ServiceCustomerPersonasApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  客户画像模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .------------------------------.    \n" +
                " |                              |    \n" +
                " |                              |    \n" +
                " |        客户画像模块启动成功      |    \n" +
