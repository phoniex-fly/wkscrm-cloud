...
public class ServiceDataLableApplication {
    public static void main(String[] args) {
        SpringApplication.run(ServiceDataLableApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  数据标签模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .------------------------------.    \n" +
                " |                              |    \n" +
                " |                              |    \n" +
                " |        数据标签模块启动成功      |    \n" +
