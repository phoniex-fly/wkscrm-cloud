...
public class ServiceDataStrategyApplication {
    public static void main(String[] args) {
        SpringApplication.run(ServiceDataStrategyApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  下发规则模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .------------------------------.    \n" +
                " |                              |    \n" +
                " |                              |    \n" +
                " |        下发规则模块启动成功      |    \n" +
