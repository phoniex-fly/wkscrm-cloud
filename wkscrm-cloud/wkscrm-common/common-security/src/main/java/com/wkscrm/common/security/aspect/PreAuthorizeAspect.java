package com.wkscrm.common.security.aspect;

import com.wkscrm.common.core.exception.PreAuthorizeException;
...
public class PreAuthorizeAspect {
    ...
    @Around("@annotation(com.wkscrm.common.security.annotation.PreAuthorize)")
